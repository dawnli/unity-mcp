...
namespace MCPForUnity.Editor.Windows.Components.Advanced
{
    ...
    public class McpAdvancedSection
    {
        ...
        private void InitializeUI()
        {
            ...
            {
                autoStartOnLoadToggle.tooltip = "Automatically connect to the configured HTTP Remote endpoint when the Unity Editor opens. HTTP Local reconnects to the fixed shared server when it is already running.";
