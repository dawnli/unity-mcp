...
manage_editor(action="open_prefab_stage", prefab_path="Assets/Prefabs/Enemy.prefab", unity_instance=PROJECT_HASH)
manage_editor(action="save_prefab_stage", unity_instance=PROJECT_HASH)   # Save changes in the open prefab stage
manage_editor(action="close_prefab_stage", unity_instance=PROJECT_HASH)  # Exit prefab editing mode back to main scene
